...
use MZoo\MzMboAccess\Dependencies\Carbon_Fields\Pimple\ServiceProviderInterface;
use MZoo\MzMboAccess\Dependencies\Carbon_Fields\Container\Condition\Factory as ConditionFactory;
...
class Container_Condition_Provider implements ServiceProviderInterface {
	 ...
	 * @param  \MZoo\MzMboAccess\Dependencies\Carbon_Fields\Container\Container $container
	 * @return array<string>
	 */
