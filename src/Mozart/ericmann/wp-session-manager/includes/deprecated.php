 ...
 * Modified by Mike iLL Kilmer on 19-October-2022 using Strauss.
...
// phpcs:disable
if (!class_exists('MZoo_MzMboAccess_WP_Session')) :
    class MZoo_MzMboAccess_WP_Session implements ArrayAccess
    {
        public static function get_instance(): MZoo_MzMboAccess_WP_Session
        {
            _doing_it_wrong('MZoo_MzMboAccess_WP_Session::get_instance', 'Please use native Session functionality.', '3.0');

            return new MZoo_MzMboAccess_WP_Session();
        }
