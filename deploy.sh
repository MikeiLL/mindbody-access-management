...
# main config
PLUGINSLUG="mindbody-access-management"
CURRENTDIR=`pwd`
MAINFILE="mz-mbo-access.php" # this should be the name of your main php file in the wordpress plugin
...
SVNURL="http://plugins.svn.wordpress.org/mindbody-access-management" # Remote SVN repo on wordpress.org, with no trailing slash
