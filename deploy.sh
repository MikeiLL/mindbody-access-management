...
CURRENTDIR=$(pwd)
default_svnpath="/tmp/mindbody-access-management"
default_svnurl="https://plugins.svn.wordpress.org/mindbody-access-management"
default_svnuser="mikeill"
default_plugindir="$CURRENTDIR"
default_mainfile="mz-mbo-access.php"
